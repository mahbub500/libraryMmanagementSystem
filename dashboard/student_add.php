        ...
        <div class="container-fluid">
          ...
          <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">                  
                   <form action="student_add_done.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                   <div class="col-md-4">
                        ...
                        <div class="form-group">
                          <input class="form-check-input ml-3" type="radio" value="1" name="gender" 
                               >
                          <label class="form-check-label ml-5" > Male</label>

                      <input class="form-check-input ml-3" type="radio" value="2" name="gender" >
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        Birth Date: <input name="BirthDate"   type="date" class="form-control" required > 
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <label class="form-check-label">
                          ...
                          <input class="form-check-input" name="education[]" type="checkbox"  value="S.Sc"> S.Sc
                        ...
                        <div class="form-check form-check-inline">
                        <label class="form-check-label">
                          <input class="form-check-input" name="education[]" type="checkbox"  value="H.Sc"> H.Sc
                          <span class="form-check-sign">
                              <span class="check"></span>
                          </span>
                        </label>
                        ...
                        <div class="form-check form-check-inline">
                        <label class="form-check-label">
                          <input class="form-check-input" name="education[]"  type="checkbox"  value="Honurs"> Honurs
                          <span class="form-check-sign">
                              <span class="check"></span>
                          </span>
                        </label>
                        ...
                        <div class="form-check form-check-inline">
                        <label class="form-check-label">
                          <input class="form-check-input" name="education[]"  type="checkbox" value="Masters"> Masters
                          <span class="form-check-sign">
                              <span class="check"></span>
                          </span>
                        </label>
                ...
                <div class="row">
                  <div class="col-md-6">
                      <label class="bmd-label-floating" > Enter Your Gender</label>
                     <div class="form-group">
                          <input class="form-check-input ml-3" type="radio" value="1" name="blood" 
                               >
                          <label class="form-check-label ml-5" > O (+)</label>
                          <input class="form-check-input ml-3" type="radio" value="2" 
                              name="blood" >
                          <label class="form-check-label ml-5" >O (-) </label>
                          <input class="form-check-input ml-3" type="radio" value="3" 
                               name="blood" >
                          <label class="form-check-label ml-5" >A (+) </label>
                          <input class="form-check-input ml-3" type="radio" value="4" 
                               name="blood" >
                          <label class="form-check-label ml-5" >A (-) </label>
                          <input class="form-check-input ml-3" type="radio" value="5" 
                               name="blood" >
                          <label class="form-check-label ml-5" >B (+) </label>
                          <input class="form-check-input ml-3" type="radio" value="6" 
                               name="blood" >
                          <label class="form-check-label ml-5" >B (-) </label>
                          <input class="form-check-input ml-3" type="radio" value="7" 
                               name="blood" >
                          <label class="form-check-label ml-5" >AB (+) </label>
                          <input class="form-check-input ml-3" type="radio" value="8" 
                               name="blood" >
                          <label class="form-check-label ml-5" >AB (-) </label>
