      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <div class="col-md-12">
            ...
            <a class="btn btn-primary mt-3" href="student_add.php"> Add Student</a> 
              <div class="card">
                <div class="card-header card-header-warning">
                  <h4 class="card-title">Students Stats</h4>
                  <p class="card-category">New student join on 15th Augst, 2021</p>
                </div>
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    ...
                    ?>
                            <tr>
                              <td scope="row" class="text-success"><?php echo $sl++;?></td>
                              ...
                              <td colspan="2">
                                  <a href="student_edit.php?id=<?php echo $student['id'];?>" class="btn btn-primary"> Edit</a>
                                     <a href="studentDelete.php?id=<?php echo $student['id'];?>" class="btn btn-danger" > Delete</a>
